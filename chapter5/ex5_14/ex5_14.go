...
// the file system hierarchy on your computer (a tree), or a list of bus or
// subway routes downloaded from your city government's web site (an undirected graph).
package main
...
func printDepends(course string) (order []string) {
